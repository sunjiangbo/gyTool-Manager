        ...
        <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" 
            ...
            <cc1:TabPanel ID="TabPanel4" runat="server" HeaderText="处理日志">
                ...
                <ContentTemplate><asp:GridView ID="TaskLogGV" runat="server" AllowSorting="True" 
                        ...
                        onrowdatabound="TaskLogGV_RowDataBound" ><RowStyle BackColor="#F7F6F3" ForeColor="#333333" /><AlternatingRowStyle BackColor="White" ForeColor="#284775" /><Columns><asp:BoundField HeaderText="序号" /><asp:BoundField DataField="DateTime" HeaderText="生成时间" /><asp:BoundField DataField="CreateUserName" HeaderText="创建人" /><asp:BoundField DataField="Title" HeaderText="标题" /><asp:BoundField DataField="Content" HeaderText="内容" /></Columns><EditRowStyle BackColor="#999999" /><FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" /><HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" /><PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" /><SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" /></asp:GridView>
                </ContentTemplate>
            </cc1:TabPanel>
            <cc1:TabPanel ID="TabPanel5" runat="server" HeaderText="流转历史">
                <ContentTemplate><asp:GridView ID="TaskFlowGV" runat="server" AutoGenerateColumns="False" 
                        CellPadding="4" ForeColor="#333333" GridLines="None" Width="640px" ><RowStyle BackColor="#F7F6F3" ForeColor="#333333" /><AlternatingRowStyle BackColor="White" ForeColor="#284775" /><Columns><asp:BoundField HeaderText="序号" /><asp:BoundField DataField="fsbm" HeaderText="发送部门" /><asp:BoundField DataField="fsz" HeaderText="发送者" /><asp:BoundField DataField="jsbm" HeaderText="接收部门" /><asp:BoundField DataField="DateTime" HeaderText="流转时间" /><asp:BoundField HeaderText="内容" /></Columns><EditRowStyle BackColor="#999999" /><FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" /><HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" /><PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" /><SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" /></asp:GridView>
                </ContentTemplate>
            </cc1:TabPanel>
