<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ToolApp.aspx.cs" Inherits="Query" %>
            ...
            if (row) {
                ...
                else
                {
                   var json = {};
                    ...
                    json.cmpoption = 0; //只比较匹配属性
                    json.toolstate = 0; //只查询在库
...
<body id = "cc" class="easyui-layout">
   ...
   <div id= "MContent" title = "查询" region="center"">
    ...
    <div id = "tb" >
        ...
        <a href="#"  class="easyui-linkbutton" iconCls="icon-add" onclick = "AddToBorrow();">添加</a>
    </div>
